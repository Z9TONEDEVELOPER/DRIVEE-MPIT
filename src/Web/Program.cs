...
builder.Services.AddSingleton<StaticFewShotProvider>();
builder.Services.AddSingleton<IFewShotFeedbackStore, JsonFileFewShotFeedbackStore>();
builder.Services.AddSingleton<IFewShotProvider, CompositeFewShotProvider>();
builder.Services.AddSingleton<NullFewShotRanker>();
builder.Services.AddSingleton<LexicalFewShotRanker>();
builder.Services.AddSingleton<HttpEmbeddingFewShotRanker>();
builder.Services.AddSingleton<IFewShotRanker>(services => FewShotRankerFactory.Create(services, builder.Configuration));
